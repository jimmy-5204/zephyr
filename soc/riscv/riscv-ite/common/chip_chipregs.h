...
#define GCR22			ECREG(EC_REG_BASE_ADDR + 0x16E7)
#define GCR23			ECREG(EC_REG_BASE_ADDR + 0x16E8)
#define GCR24			ECREG(EC_REG_BASE_ADDR + 0x16E9)
...
#define WUEMR5			ECREG(EC_REG_BASE_ADDR + 0x1B0C)
...
#define WUEMR15			ECREG(EC_REG_BASE_ADDR + 0x1B34)
#define WUEMR16			ECREG(EC_REG_BASE_ADDR + 0x1B38)
...
#define WUESR5			ECREG(EC_REG_BASE_ADDR + 0x1B0D)
...
#define WUESR15			ECREG(EC_REG_BASE_ADDR + 0x1B35)
#define WUESR16			ECREG(EC_REG_BASE_ADDR + 0x1B39)
...
#define WUBEMR2			ECREG(EC_REG_BASE_ADDR + 0x1B3D)
#define WUBEMR4			ECREG(EC_REG_BASE_ADDR + 0x1B3F)

#define WUEMR6_BASE		(EC_REG_BASE_ADDR + 0x1B10)
#define WUESR6_BASE		(EC_REG_BASE_ADDR + 0x1B11)
#define WUBEMR5			ECREG(EC_REG_BASE_ADDR + 0x1B05)
#define WUBEMR6			ECREG(EC_REG_BASE_ADDR + 0x1B13)
#define WUBEMR7			ECREG(EC_REG_BASE_ADDR + 0x1B17)
...
#define WUBEMR12		ECREG(EC_REG_BASE_ADDR + 0x1B2B)
#define WUBEMR13		ECREG(EC_REG_BASE_ADDR + 0x1B2F)
#define WUBEMR14		ECREG(EC_REG_BASE_ADDR + 0x1B33)
#define WUBEMR15		ECREG(EC_REG_BASE_ADDR + 0x1B37)
#define WUBEMR16		ECREG(EC_REG_BASE_ADDR + 0x1B3B)
